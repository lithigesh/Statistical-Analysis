  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-sm border border-gray-200">
      ...
      <button
        ...
        className="w-full bg-indigo-600 text-white py-3 px-6 rounded-md hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors font-medium mb-8"
      >
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg text-center border border-gray-100">
              <h4 className="font-medium text-gray-700 mb-2">Slope Coefficient</h4>
              <p className="text-2xl font-semibold text-indigo-600">{results.slope?.toFixed(4)}</p>
              <p className="text-xs text-gray-500 mt-1">Change in Y per unit X</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg text-center border border-gray-100">
              <h4 className="font-medium text-gray-700 mb-2">Y-Intercept</h4>
              <p className="text-2xl font-semibold text-indigo-600">{results.intercept?.toFixed(4)}</p>
              <p className="text-xs text-gray-500 mt-1">Y value when X = 0</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg text-center border border-gray-100">
              <h4 className="font-medium text-gray-700 mb-2">R² Coefficient</h4>
              <p className="text-2xl font-semibold text-indigo-600">{results.rSquared?.toFixed(4)}</p>
              <p className="text-xs text-gray-500 mt-1">Goodness of fit</p>
            </div>
          </div>
